    ...
    Rules(String name) {
        ...
        rules.setText(
            "<html>"+ 
                ...
                "4. If you do not answer a question within 15 seconds, it will be marked incorrect.." + "<br><br>" +
                "5. You have three 50/50 lifelines that you can use on any question." + "<br><br>" +
                "6. To use a 50/50 lifeline, click the \"50/50\" button. This will remove two incorrect answer choices, leaving you with two choices." + "<br><br>" +
